...
4. Enter the name, date of birth, and PAN number, then run KYC through card read, comparison with those entered details, tilt, and liveness motion. Identity values are not spoken aloud.
